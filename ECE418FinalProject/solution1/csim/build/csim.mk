...
$(ObjDir)/WorkingCodeNew.o: ../../../WorkingCodeNew.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../WorkingCodeNew.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/WorkingCodeNew.d
