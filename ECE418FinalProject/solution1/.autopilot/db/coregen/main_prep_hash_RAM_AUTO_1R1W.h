...
// ==============================================================
#ifndef __main_prep_hash_RAM_AUTO_1R1W_H__
#define __main_prep_hash_RAM_AUTO_1R1W_H__
...
struct main_prep_hash_RAM_AUTO_1R1W_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(main_prep_hash_RAM_AUTO_1R1W_ram) {
...
SC_MODULE(main_prep_hash_RAM_AUTO_1R1W) {
...
main_prep_hash_RAM_AUTO_1R1W_ram* meminst;


SC_CTOR(main_prep_hash_RAM_AUTO_1R1W) {
meminst = new main_prep_hash_RAM_AUTO_1R1W_ram("main_prep_hash_RAM_AUTO_1R1W_ram");
